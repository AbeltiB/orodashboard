...
export default function CashierDepositsPage() {
    ...
    <>
      ...
      <main style={{ minHeight: "100vh", background: "var(--background)", padding: "20px 16px 60px" }}>
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "flex-start", padding: "10px 12px", borderRadius: 9, background: "var(--background)", border: "1px solid var(--border)", marginBottom: 18, fontSize: 12.5, color: "var(--muted-foreground)" }}>
            Deposit verification is currently paused — submissions are still tracked here, but this isn&apos;t the primary daily tool right now. Use the Sales tab for day-to-day reconciliation.
          </div>
