...
export function serializeOtaVehicle(v: OtaVehicle) {
  return {
    ...
    departureTerminalName: v.departureTerminalName,
    arrivalTerminalName: v.arrivalTerminalName,
    routeDistanceKm: v.routeDistanceKm ? toNumber(v.routeDistanceKm) : null,
    raw: v.raw,
